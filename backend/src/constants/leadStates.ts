 ...
 *
 * Lifecycle:
 * NEW -> ASSIGNED -> CONTACTED -> TAGGED -> VISIT_REQUESTED -> VISIT_ASSIGNED
 * -> VISIT_COMPLETED -> SOLD -> ORDER_CREATED -> CLOSED
 *
 * Alternate flows:
 * CONTACTED -> REJECTED | INVALID
 * VISIT_COMPLETED -> WAITING_NURTURE -> RE_ENGAGED -> SOLD
 * ANY -> DORMANT
 */
